...
class CssEnvironment(Environment):
    ...
    def step(self, action: CssAction) -> CssObservation:
        ...
        repeated_action = self._action_signature(action) == self.state_data.get("last_action_signature")
        ...
        self.state_data["last_action_signature"] = self._action_signature(action)
    ...
    def state(self) -> State:
        ...
        return State(
            ...
            reward=self.state_data.get("last_reward", 0.0),
